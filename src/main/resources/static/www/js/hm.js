(function () {
    var h = {}, mt = {}, c = {
        id: "1bc8367b0f696a805da6a720e42beecc",
        dm: ["banlidy.com"],
    ...
    (mt.h.Ga = function () {
        ...
        (function () {
            if (!d) if (d = r, "complete" === document.readyState) a.B = r; else if (document.addEventListener) document.addEventListener("DOMContentLoaded",
    ...
    (function () {
        ...
        function b() {
            ...
            if ((!l || !e) && p && k) y = r, m = +new Date; else if (l && e && (!p || !k)) y = u, s += +new Date - m;
            l = p;
            e = k;
            z = setTimeout(b, 100)
        }
        ...
        var g = mt.event, n = h.H, l = r, p = r, e = r, k = r, w = +new Date, m = w, s = 0, y = r,
            v = d("visibilityState"), x = d("hidden"), z;
        b();
        (function () {
    ...
    (function () {
        var a = mt.lang, b = h.s, d = h.load, f = {
            Ca: function (g) {
    ...
    (function () {
        ...
        var d = mt.lang, f = mt.l, g = mt.f, n = h.s, l = h.H, p = h.ha, e = {
            w: [], C: 0, Y: u, o: {V: "", page: ""}, init: function () {
                e.e =
                    0;
                l.c("pv-b", function () {
                    e.ia();
            ...
            _trackEvent: function (a) {
                ...
                if (d.d(a, "Object")) {
                    ...
                    if (900 >= m) g.call(this, a); else for (var m = Math.ceil(m / 900), s = "block|" + Math.round(Math.random() * n.R).toString(16) + "|" + m + "|", l = [], v = 0; v < m; v++) l.push(v), l.push(a.substring(900 * v, 900 * v + 900)), g.call(this, s + l.join("|")), l = []
                }
    ...
    (function () {
        ...
        var b = mt.url, d = mt.aa, f = mt.U, g = mt.lang, n = mt.cookie, l = mt.f, p = mt.localStorage,
            e = mt.sessionStorage, k = h.s, w = h.H;
        a.prototype = {
            P: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                try {
                    n.set(a, b, {domain: this.J(), path: this.W(), I: d}), d ? p.set(a, b, d) : e.set(a, b)
                } catch (f) {
                }
            }, Ha: function (a) {
                try {
                    n.set(a, "", {domain: this.J(), path: this.W(), I: -1}), e.remove(a), p.remove(a)
                } catch (b) {
                }
            }, Ma: function () {
                var a, b, d, e, f;
                ...
                var a = document.location.hash.substring(1), d = RegExp(c.id),
                    e = b.K(document.referrer) === k.ea ? 1 : 0, f = b.i(a, "jn"),
    ...
    (function () {
        var a = mt.event, b = mt.lang, d = h.s;
