!function (e, o, n) {
    ...
    function r(e, o) {
        for (var n, t, r = e.split(":"), a = r.pop().split("/"), s = l; n = a.shift();) "bdbox" !== n && (t = n, a.length && (s = s[n] = s[n] || {}));
        var c = u[e] = {exports: {}}, d = l.isFunction(o) ? o.apply(c, [i, c.exports, c, l]) : o;
        d && (c.exports = d), s[t] = c.exports
    }

    function a() {
        var e, o, n = "__OPENBOX_CHECK_LOCALSTORE__", t = {name: "openbox", content: "check_localStorage"};
        try {
    ...
    function s() {
        ...
        try {
            if (x = JSON.parse(localStorage.getItem(o)), x.timeout > Date.now()) return
        } catch (t) {
        }
        if (a()) {
            var r = i("common:bdbox/io/loadJS");
            r({
                url: "https://ext.baidu.com/rest/id-mapping/cuid?callback=?", success: function (t) {
                    if ("0" === t.errno) {
                        var i, r, a, s, c, d = t.data || {}, p = d.status, l = d.list || [];
                        if ("0" === p) s = "lite", c = "main"; else {
                        ...
                        x = {firstOpen: s, secondOpen: c, status: p, timeout: Date.now() + 864e5};
                        try {
    ...
    var c = +new Date, d = (c + "").slice(-3), p = navigator.userAgent, l = {
        isBoxApp: function (e) {
            return e = e || "", / baiduboxapp\//i.test(p) === !1 ? !1 : p.indexOf(e + " baiduboxapp") < 0 ? !1 : !0
        }, isBox: / baiduboxapp\//i.test(p) && !/ (lite|info|mission) baiduboxapp/.test(p), $isBox: function () {
            var o = e.navigator || {}, n = o.userAgent;
            return / baiduboxapp\//i.test(n) && !/ (lite|info|mission) baiduboxapp/.test(n)
        }, isLiteBox: / (lite|info) baiduboxapp\//i.test(p), $isLiteBox: function () {
            var o = e.navigator || {}, n = o.userAgent;
            return / (lite|info) baiduboxapp\//i.test(n)
        }, isInfoBox: / info baiduboxapp\//i.test(p), $isInfoBox: function () {
            var o = e.navigator || {}, n = o.userAgent;
            return / info baiduboxapp\//i.test(n)
        }, isProBox: / pro baiduboxapp\//i.test(p), $isProBox: function () {
            var o = e.navigator || {}, n = o.userAgent;
            return / pro baiduboxapp\//i.test(n)
        }, isIOS: /(iPhone|iPod|iPad)/.test(p), $isIOS: function () {
            var o = e.navigator || {};
            return /(iPhone|iPod|iPad)/.test(o.userAgent)
        }, isAndroid: /(Android);?[\s\/]+([\d.]+)?/.test(p), $isAndroid: function () {
            var o = e.navigator || {};
            return /(Android);?[\s\/]+([\d.]+)?/.test(o.userAgent)
        }, getId: function () {
            return d++
        }, emptyArr: [], emptyFn: function () {
        }, cleanObj: {}, byId: function (e) {
            return l.isString(e) ? o.getElementById(e) : e
        }, toArray: function (e) {
            return l.emptyArr.slice.call(e)
        }, $: function (e, n) {
            return n = n && 1 === n.nodeType ? n : o, l.toArray(n.querySelectorAll(e))
        }
    };
    ...
    r("common:bdbox/utils/version_compare", function (e, o, n) {
        ...
        n.exports = function (e) {
            var o = e.split("?"), n = o[1] ? o[1] : o[0], t = n.split("&"), i = {};
        ...
        var c = n("common:bdbox/utils/jsonToQuery"), d = r.emptyFn;
        i.exports = a
        ...
        function r(o) {
            ...
            var s = o.match(/(iPad).*OS\s([\d_]+)/), c = o.match(/(iPod)(.*OS\s([\d_]+))?/),
        ...
        var r = t.isPlainObject, a = t.isArray, s = t.isBoolean, c = t.isUndefined;
        n.exports = function (e) {
        ...
        var t = Object.prototype.toString, i = function (e, o, n) {
            var t = 0;
            for (var i in e) if (e.hasOwnProperty(i)) if (n) o[i] = e[i]; else if (o(i, e[i], t++)) break
        }, r = function (e) {
            var o;
            switch (t.call(e)) {
                case"[object Object]":
        ...
        var r = function () {
            var o = 0;
            if (e.baiduboxapp_version) o = e.baiduboxapp_version; else if (i.$isBox()) {
        ...
        var r = o("common:bdbox/monitor"), a = o("common:bdbox/extend"), s = o("common:bdbox/utils/queryToJson"),
            c = o("common:bdbox/utils/getVersion"), d = o("common:bdbox/clone"), p = s(location.search),
            l = navigator.userAgent, u = e.location.protocol;
        "http:" !== u && (u = "https:");
        var m = u + "//m.baidu.com/tcbox", b = {
            service: "bdbox",
            action: "pblog",
            ctv: 2,
            cen: "uid_ua_ut",
        ...
        var x, h = r(m, {
            customHandler: function (e) {
                var o = [];
                if (x) for (var n in x) if (x.hasOwnProperty(n)) {
                    var t = x[n];
        ...
        h.init = function (e, o) {
            ...
            } else var s = {evtName: e, evtType: o || "", evtTag: n || ""};
            x = d(b);
            var p = x.data;
        ...
        function a(n, t, i, r, a) {
            if (k.ios && B(k.version, "9.0") >= 0) e.location.href = n; else if (k.android && "chrome" === O && d() > 55 && navigator.userAgent.indexOf("haokan") < 0) e.location.href = n; else {
        ...
        function c(e) {
            ...
            var n;
            for (n in v) o[n] = v[n];
            for (var t in o) if (o.hasOwnProperty(t) && o[t].test(e) && (k.ios || "safari" != t)) return t;
            if (k.ios) {
        ...
        function d() {
            ...
            if (!e) return 0;
            var o = e.split(".")[0], n = parseInt(o, 10);
            return n
        }
        ...
        var u, m,
            ...
            }, g = {chrome: /\bCriOS\/([\d.]+)/, firefox: /\bFxiOS\//i, maxthon: /\bMXiOS\//i}, y = {
                firefox: /\bFirefox\//i,
                opera: /\bOPR\//i,
            ...
            }, w = r, k = n("common:bdbox/utils/detect")(), B = n("common:bdbox/utils/version_compare"),
            E = n("common:bdbox/utils/queryToJson"), C = E(e.location.href), O = c(e.navigator.userAgent),
            S = n("common:bdbox/monitor/pblog");
        S("init", [14]), i.exports = function (n, t) {
            function i() {
                c || !k.isWechat && !k.isQQ ? a(D, R, u, d, _) : (f = l(f, "pkgname", r), U && (f = l(f, "ckey", U)), f = l(f, "android_scheme", encodeURIComponent(D)), e.location.href = f)
            }

            if (!w.$isBox() && w.isObject(n)) {
                var r, c = 1 == n.overwrite ? 1 : 0, d = n.from || n.sfrom || "other", u = n.waitTime || 100,
                    m = n.failUrl || "", b = n.failUrlWidthScheme || "", v = n.failUrlParams || "", g = n.token || "",
                    y = n.ts || "", E = n.appid || "", A = n.idmData || {}, I = n.matrix || "", T = {
                        source: d,
                        from: "openbox",
                        page: O,
                ...
                var U = P.ckey, j = o.cookie || "", z = /baiduid=(.+?);/i, F = j.match(z);
                F && F.length && (T.baiduId = F[1] || "");
                var R;
                if (R = w.isFunction(n.failCallback) ? n.failCallback : n.channel ? h + "?from=" + n.channel : h, k.android && n.androidCommand) {
                    var D;
                    if (w.isObject(n.androidCommand)) {
                        var M = "7.4";
                        (n.androidCommand.minver || "lite" === n.matrix) && (M = n.androidCommand.minver || "3.3", delete n.androidCommand.minver);
                        var H = "";
                    ...
                    } else D = n.androidCommand;
                    T.app_now = O + "_" + Date.now() + "_" + (Math.random() + "").slice(-10), T.yyb_pkg = r, T.idmData = A, T.matrix = I, D = D + "&needlog=1&logargs=" + encodeURIComponent(JSON.stringify(T)), t ? i() : S("event", ["openBox", d, T, null, i])
                    ...
                    if (T.isUL = B(k.version, "9.0") >= 0 && !c ? 1 : 0, S("event", ["openBox", d, T]), B(k.version, "9.0") < 0 || c || n.iosForceScheme) !c && k.isWechat ? s() : a(Q, R, u, d, _); else {
                        var $ = x + encodeURIComponent(Q);
                        $ = l($, "source", d), $ = l($, "channel", n.channel), v && ($ = l($, "failurlparams", encodeURIComponent(v))), "" != m && (b && (m = l(m, "scheme", encodeURIComponent(Q))), $ += "&target=" + encodeURIComponent(m), $ += "&token=" + encodeURIComponent(g), $ += "&ts=" + encodeURIComponent(y), $ += "&appid=" + encodeURIComponent(E)), $ = l($, "tokenData", encodeURIComponent(JSON.stringify(_))), e.location.href = $
                    }
                } else w.isFunction(R) ? R() : e.location.href = R
            }
        }
    });
    ...
    r("common:bdbox/clone", function (e, o, n) {
        ...
        n.exports = function (e, o, n) {
            if (t.isArray(e)) {
                for (var i = 0; i < e.length; i++) if (o.call(n || e[i], e[i], i) === !1) return e
            } else for (var r in e) if (o.call(n || e[r], e[r], r) === !1) return e;
            return e
        }
        ...
        function a(e) {
            var o = ("" + e).split(".");
            return {e: o[0], ns: o.slice(1).sort().join(" ")}
        }
        ...
        function x(e, o) {
            ...
            return r && (i = tempParent).appendChild(e), t = ~I(i, o).indexOf(e), r && tempParent.removeChild(e), t
        }
        ...
        var v = e("common:bdbox/utils/each"), g = /^\.([\w-]+)$/, y = /^#([\w-]*)$/, w = /^[\w-]+$/,
            k = {mouseenter: "mouseover", mouseleave: "mouseout"}, B = {}, E = function () {
                return !0
            }, C = function () {
                return !1
            }, O = /^([A-Z]|layer[XY]$)/, S = {
    ...
    var f = ".openBox-shareEntry *,.openBox-shareEntry *:before,.openBox-shareEntry *:after{    margin: 0;    padding: 0;}.openBox-shareEntry {    margin: 0;    padding: 0;    position: relative;    width: 100%;    height: 60px;}.openBox-shareEntry div {  /* UC下被屏蔽 */    display: block !important;}.openBox-shareEntry .shareEntry-blank {    box-sizing: border-box;    width: 100%;    height: 60px;    padding: 0px 18px;    position: fixed;    left: 0;    bottom: 0;    z-index: 9999;    display: -webkit-box !important;    display: box !important;    -webkit-box-align: center;    box-align: center;    background-color: rgba(0, 0, 0, 0.7);}.openBox-shareEntry .shareEntry-box {    -webkit-box-flex: 1;    box-flex: 1;    display: -webkit-box !important;    display: box !important;    box-sizing: border-box;    -webkit-box-align: center;    box-align: center;}.openBox-shareEntry .shareEntry-box .shareEntry-icon {    height: 40px;    width: 40px;    background: url(//s.bdstatic.com/common/openjs/openBox/shareEntry-logo.png) no-repeat;    background-size: 40px 40px;    border-radius: 4px;    overflow: hidden;    margin-right: 12px;}.openBox-shareEntry .shareEntry-box .shareEntry-text {    -webkit-box-flex: 1;    box-flex: 1;}.openBox-shareEntry .shareEntry-box .shareEntry-title {    text-align: left;    line-height: 1;    font-weight: bold;    color: #FFFFFF;    font-size: 17px;}@media only screen and (max-width: 320px) {    .openBox-shareEntry .shareEntry-box .shareEntry-title {        font-size: 15px;    }}.openBox-shareEntry .shareEntry-box .shareEntry-cont {    text-align: left;    white-space: nowrap;    overflow: hidden;    color: #999999;    margin-top: 4px;    line-height: 1.2;    -webkit-text-size-adjust: none;    font-size: 13px;}@media only screen and (max-width: 320px) {    .openBox-shareEntry .shareEntry-box .shareEntry-cont {        font-size: 10px;    }}.openBox-shareEntry .shareEntry-app {    width: 75px;    box-sizing: border-box;    margin-left: 12px;}.openBox-shareEntry .shareEntry-app .shareEntry-btn {    display: block;    width: 75px;    height: 30px;    line-height: 30px;    text-align: center;    color: #ffffff;    font-size: 15px;    border-radius: 4px;    background-color: #3c76ff;}",
        x = {firstOpen: "main", secondOpen: "lite", status: "-1"};
    s(), e.OpenBox = function (t) {
        function r(e) {
            w ? e() : y.push(e)
        }

        function a() {
            w || (w = !0, y.forEach(function (e) {
                e()
            }), y.length = 0)
        }

        function s(e, o) {
            e = e || {}, o === n && (o = !0), e.matrix || k.matrix || (e.matrix = "main"), !e.matrix && k.matrix && (e.matrix = k.matrix);
            var t = {
                main: {protocolHeader: "baiduboxapp", packageName: "com.baidu.searchbox"},
                lite: {protocolHeader: "baiduboxlite", packageName: "com.baidu.searchbox.lite"},
                info: {protocolHeader: "baiduinfoapp", packageName: "com.baidu.searchbox.info"},
                pro: {protocolHeader: "baiduboxpro", packageName: "com.baidu.BaiduMobilePlus"}
            };
            return e.protocolHeader = t[e.matrix || "main"].protocolHeader || t.main.protocolHeader, e.packageName = t[e.matrix || "main"].packageName || t.main.packageName, o ? (v(!0, k, e), !0) : e
        }
        ...
        function d(e, o) {
            if (e) {
                var n = S(k);
                return v(!0, n, s(e, !1)), void E(l(n), o)
            }
        ...
        function p(e) {
            ...
            if (null == e.failCallback && null == t.failCallback && b.android && (e.failCallback = function () {
                var n = e.channel || t.channel || "757b", i = e.from || t.from || "";
                h(n, i, o)
            }, /\bliebao/i.test(navigator.userAgent) && (e.failCallback = n), /\(.*Android.*(SAMSUNG|SM-).*\)/.test(navigator.userAgent) && (/MQQBrowser\//i.test(navigator.userAgent) || /UCBrowser\//i.test(navigator.userAgent)) && (e.failCallback = n)), !x || !b.android || /micromessenger\//i.test(navigator.userAgent) || /\bQQ\//.test(navigator.userAgent)) return void d(e);
            if (e.notUseIdm || t.notUseIdm) return void d(e);
            var i = e.from || t.from || "";
            if (["neibu_shouye_yuyinsousuo", "neibu_sousuojieguoye_yuyinsousuo", "1019696a"].indexOf(i) >= 0) return void d(e);
            var r = x.firstOpen, a = e;
            a.idmData = x;
            var s = S(a), c = x.secondOpen;
        ...
        function l(o) {
            var n = S(o);
            return b.ios && !n.iosScheme ? n.iosScheme = n.url ? u(n.url).iosScheme : u(e.location.href).iosScheme : b.android && !n.androidCommand && (n.androidCommand = n.url ? u(n.url).androidCommand : u(e.location.href).androidCommand), 1 == n.overwrite && (n.failCallback = m.isFunction(n.failCallback) ? n.failCallback : function () {
            }), n
        }

        function u(e) {
            var o = {}, n = encodeURIComponent(e);
            return o.iosScheme = k.protocolHeader + "://easybrowse?opentype=1&openurl=" + n + "&isla=0&newbrowser=1", o.androidCommand = {
                mode: "0",
        ...
        function h(n, t, i) {
            ...
            var a, s, c = {
                ...
                huawei: {reg: /\(.*Android.*(HUAWEI|HONOR).*\)/i, scheme: "appmarket://details?id=com.baidu.searchbox"},
                oppo: {
                    reg: /\(.*Android.*OPPO.*\)/,
                    scheme: "oppomarket://details?packagename=com.baidu.searchbox",
                    downloadFirst: !0
                },
                vivo: {reg: /\(.*Android.*(vivo|VIVO).*\)/, scheme: "vivomarket://details?id=com.baidu.searchbox"}
            };
            for (a in c) {
        ...
        if (m.isBox) {
            ...
            return {ready: g, open: g}
        }
        var y = [], w = !1, k = {tipTexts: {title: "百度", subtitle: "打开百度App，遇见更多精彩。", button: "立刻打开"}};
        if (s(t), t && b.ios && t.iosScheme) k.iosScheme = t.iosScheme, a(); else if (t && b.android && t.androidCommand) k.androidCommand = t.androidCommand, a(); else if (t && t.serverSchemeInfo) {
            ...
            B({
                ...
                success: function (e) {
                    try {
                        0 == e.errno && e.data && (b.ios ? (k.iosScheme = e.data.cmd.url, a()) : b.android && (k.androidCommand = e.data.cmd, a()))
                    } catch (o) {
                    }
                },
                error: function (e) {
        ...
        t && t.showTip && r(c);
        var E = i("common:bdbox/invoke/openBox"), C = "openBox", O = i("common:bdbox/event/delegate"),
        ...
        return O.on(o.body || o.documentElement, "[data-box]", "click", function () {
            if (~this.dataset.box.indexOf(C)) {
                ...
                if (p(e), 1 != e.overwrite) return !1
            }
        }), {ready: r, open: p, version: 20170811}
