!function (e) {
    ...
    2: function (e, n, t) {
        ...
        function c(e) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : v,
                t = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : v,
                o = parseInt(1e3 * Math.random(), 10), r = "cambrian_sync_loader_success" + +new Date + o,
        ...
        function u(e) {
            var n = Object.keys(e), t = n.map(function (n) {
        ...
        function l(e) {
            u(h({s_type: "ab"}, e, {pid: 66, sub_pid: 1, log_type: 1, ver: "1.0.17", pt: "online"}))
        }
        ...
        var v = function () {
            }, w = document, b = "getElementsByTagName", g = "createElement", y = "https:", _ = "cambrian6086c20b",
            O = "https://xiongzhang.baidu.com/xzhstatistics/rp", I = 0, C = "cambrian"
    }, 3: function (e, n, t) {
        "use strict";
        ...
        Object.defineProperty(n, "__esModule", {value: !0}), n.Invoker = function e(n) {
        ...
        "use strict";
        var o = t(3), r = t(2), i = window.cambrian = {}, a = window["cambrian6086c20b"] = {
            invokerCache: [],
            data: JSON.parse('"{"office_info":{"appid":1588230667845983,"pa_uid":17592191071200,"name":"\u677f\u6817\u7535\u5f71","avatar":"https:\/\/cambrian-images.cdn.bcebos.com\/4ad30772176c6fde73b12dbc4bf404ab_1532781670669.jpeg","description":"2018\u6700\u65b0\u7535\u5f71\u7b2c\u4e00\u65f6\u95f4\u66f4\u65b0\u653e\u9001\u597d\u770b\u7684\u7535\u5f71\u3002"},"client_id":"","homepage":"https:\/\/m.baidu.com\/l=1\/tc?sec=34982&di=1282619b9665f087&bdenc=1&nsrc=IlPT2AEptyoA_yixCFOxCGZb8c3JV3T5ABOIQSZLAHSwnESzbbrgHtkfEFX8L8KTZpPPdTPWqRsCwH_h_G9i8BlDrbdnpTthlCDwdsigxdLXWM2yrc1k0tPWSSkoyLm&lid=3012321920&clk_extra=%7B%22a%22%3A1588230667845983%7D","login":0,"subscribe":0,"abilities":["init","render","authorize","bar","destory","isIos","isAndroid","boxVersionCompare","isBox","boxVersion","isSubscribe"],"schemes":[],"timestamp":0,"nonce_str":null,"url":null,"signature":null,"bdstoken":"647e54ebc21cf2e98965f8b23e813fbc","tp_id":0,"tp_client_id":null,"auth_token":null,"auth_result":{"code":306000,"msg":"\u7f3a\u5931\u53c2\u6570: timestamp"}}'.substr(1)),
            logData: {cs: (new Date).getTime()},
            code: "0"
        };
        ...
        ["getInfo", "subscribe", "bar", "render", "isSubscribe", "isBox", "isIos", "isAndroid", "boxVersion", "boxVersionCompare", "invokeIM", "follow", "wysFollow", "query", "share", "authorize", "init", "destory", "login", "isLogin", "tel", "sms", "silentSubscribe", "invokeBcpIM"].forEach(function (e) {
            i[e] = function () {
                ...
                "render" === e && (n = {data: {type: n, anchor: t}}), n.log = {
                    name: e,
                    ct: (new Date).getTime(),
                    pt: "online",
                    cltype: 0
